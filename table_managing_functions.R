...
# stringMerge retuns a concatenation of unique strings
# e.g., stringMerge("A", "A", "A") returns "A"
#  whereas stringMerge("A", "B", "C", "A") returns "A/B/C"
...
# r-to-z and z-to-r. Probably simpler to use tanh() and atanh()
r2ztrans = function(r) .5*log((1+r)/(1-r))
z2rtrans = function(z) (exp(2*z) - 1) / (exp(2*z) + 1)

# Oh my god this is so bizarrely specific to the Craig study. Damnit.
